...
_NLU_INTENT_PATTERNS_EN: Dict[str, List[str]] = {
    "L22": [
        ...
        r"(?:\bex\b|ex-boyfriend|ex-girlfriend|ex-husband|ex-wife).*(?:follow|stalk|harass|threaten|call|message|show\s*up)",
    ...
    "L11": [
        r"(?:debt|loan|interest|creditor).*(?:can't\s*pay|overwhelm|restructur|bankrupt|how|harass|call|collect)",
    ...
    "L31": [
        ...
        r"(?:eminent\s*domain|expropriat|compulsory\s*acquisition).*(?:compensation|unfair|how|challenge)",
    ],
    "L42": [
    ...
    "L15": [
        ...
        r"(?:open|start|run).*(?:cafe|restaurant|shop|store|franchise|business).*(?:friend|partner|together|how)",
    ...
    "L44": [
        ...
        r"(?:nursing\s*home|care\s*facility|elderly\s*care|senior\s*center).*(?:neglect|abuse|mistreat|how|report|complaint)",
    ],
    "L45": [
    ...
    "L33": [
        r"(?:drone|UAV|unmanned).*(?:regulat|permit|register|flight|restrict|how|accident|crash|damage|injur|collid)",
    ...
    "L48": [
        r"(?:artist|art\s*worker|arts?\s*welfare).*(?:register|certif|support|insurance|contract|how|not\s*paid|unpaid|payment)",
        r"(?:performance|exhibition|festival).*(?:contract|cancel|compensat|liable|how|dispute|paid|payment|unpaid)",
