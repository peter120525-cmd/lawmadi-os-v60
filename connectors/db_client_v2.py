...
def classify_query_category(query: str) -> str:
    ...
    categories = {
        ...
        "소비자": ["환불", "소비자", "쇼핑몰", "전자상거래", "반품", "교환", "청약철회", "하자", "중고차",
                "약관", "불공정 약관", "제조물책임", "홈쇼핑", "통신판매", "방문판매", "다단계", "불량 제품"],
        "민사": ["손해배상", "계약", "채권", "채무", "소송", "민사", "누수", "층간소음",
                "개인회생", "파산", "면책", "빚", "대출", "빌려", "갚", "배상", "교통사고"],
        "형사": ["고소", "고발", "형사", "범죄", "처벌", "벌금", "사기", "폭행",
                "명예훼손", "모욕", "음주운전", "협박", "허위사실"],
        "가족법": ["이혼", "양육", "상속", "유언", "가족", "혼인"],
        "부동산": ["부동산", "매매", "등기", "아파트", "토지"],
        "노동": ["해고", "노동", "임금", "퇴직", "산재", "근로", "직장내괴롭힘", "괴롭힘"],
        "행정": ["행정", "인허가", "과태료", "행정처분", "징계", "공무원", "행정소송", "민원"],
        "지식재산": ["특허", "상표", "저작권", "지식재산", "초상권"],
        "회사법": ["회사", "법인", "주주", "이사", "기업", "동업"],
        "세금": ["세금", "국세", "지방세", "증여세", "상속세", "체납", "세무"],
    }
