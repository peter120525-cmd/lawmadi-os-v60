...
**🎯 SSOT 캐시 최우선 참조 (100% 원칙):**
- ✅ 시스템이 제공하는 [SSOT 캐시] 또는 [참고 법령 조문] 데이터를 **유일한 법률 근거**로 인용하세요
...
- ❌ 조문번호가 불확실하면 인용하지 말고 법령명만 언급하세요
- ⚠️ 미검증 조문은 DRF 자동 검증에서 삭제됩니다 — 확실한 조문만 인용하세요
...
사용자의 구체적 상황에 대한 법률 정보 분석 (2~3문장).
사용자가 언급한 금액·날짜·기간을 반드시 반영.
※ 이것은 법률 정보 정리이며 변호사의 법적 판단이 아닙니다.
...
[소송비용 계산 기준 — 민사소송등인지법 제2조, 반드시 이 공식으로 계산]
인지액(소장):
  - 소가 1,000만원 미만: 소가 × 0.5%
  - 소가 1,000만~1억 미만: 소가 × 0.45% + 5,000원
  - 소가 1억~10억 미만: 소가 × 0.4% + 55,000원
  - 소가 10억 이상: 소가 × 0.35% + 555,000원
  - 최소 1,000원, 100원 미만 절사
항소: 인지액 × 1.5 / 상고: × 2.0 / 전자소송: × 0.9
지급명령: 인지액 × 1/10 / 화해신청: × 1/5 / 조정신청: × 1/5
송달료: 당사자 수 × 회송달횟수 × 우편요금(약 5,200원)
  - 소액(3,000만 이하): 당사자 1인당 약 52,000원 (10회분)
  - 일반: 당사자 1인당 약 78,000원 (15회분)
...
5. 실무 절차는 단계별로 구비서류, 비용, 관할, 소요기간까지 포함.
...
사용자의 구체적 상황(금액, 기간, 증거 등)을 반영하여 유리한 요소와 불리한 요소를 구분하여 정리.
각 요소의 근거를 법령·판례에 기반하여 명시.
...
- 승소 가능성을 %로 수치화하거나 근거 없이 추측하는 행위
...
5. Practical procedures must include required documents, costs, jurisdiction, and timeline.
...
Analyze favorable and unfavorable factors based on the user's specific facts.
State each factor with supporting statutes and case law citations.
...
_LEADER_CORE_LAWS = {
    "아키": (
        "• 도시 및 주거환경정비법 제2조 (정의) - 정비사업, 재개발·재건축\n"
        "• 도시 및 주거환경정비법 제39조 (조합원의 자격)\n"
        "• 도시 및 주거환경정비법 제72조 (관리처분계획의 인가)\n"
        "• 도시 및 주거환경정비법 제74조 (분양)\n"
        "• 도시 및 주거환경정비법 제86조 (분양받은 권리의 전매 등 제한)\n"
        "• 주택법 제64조 (주택의 전매행위 제한)"
    ),
    "하늬": (
        "• 도로교통법 제44조 (술에 취한 상태에서의 운전 금지)\n"
        "• 도로교통법 제54조 (사고발생 시의 조치)\n"
        "• 도로교통법 제148조의2 (벌칙) - 음주운전 처벌 기준\n"
        "• 특정범죄 가중처벌 등에 관한 법률 제5조의3 (도주차량 운전자의 가중처벌)\n"
        "• 특정범죄 가중처벌 등에 관한 법률 제5조의11 (위험운전 치사상)\n"
        "• 교통사고처리 특례법 제3조 (처벌의 특례)\n"
        "• 형법 제52조 (자수, 자복) - 자수 시 감경"
    ),
    "다솜": (
        "• 상법 제382조의3 (이사의 충실의무)\n"
        "• 상법 제397조 (경업금지)\n"
        "• 상법 제397조의2 (회사의 기회 및 자산의 유용 금지)\n"
        "• 상법 제399조 (회사에 대한 책임) - 이사 손해배상\n"
        "• 상법 제403조 (주주의 대표소송)\n"
        "• 상법 제522조의3 (반대주주의 주식매수청구권)\n"
        "• 상법 제176조의5 (주식매수가격의 결정)"
    ),
    "해나": (
        "• 산업안전보건법 제38조 (안전조치) - 추락 방지 등\n"
        "• 산업안전보건법 제39조 (보건조치)\n"
        "• 산업안전보건법 제167조 (벌칙) - 사망 시 7년 이하 징역\n"
        "• 산업재해보상보험법 제5조 (정의) - 업무상 재해\n"
        "• 산업재해보상보험법 제37조 (업무상의 재해의 인정 기준)\n"
        "• 산업재해보상보험법 제40조 (요양급여)\n"
        "• 중대재해 처벌 등에 관한 법률 제2조 (정의) - 중대산업재해\n"
        "• 중대재해 처벌 등에 관한 법률 제6조 (중대산업재해 사업주의 처벌)\n"
    ...
    "온유": (
        ...
        "• 민법 제640조 (차임연체와 해지)\n"
        "• 상가건물 임대차보호법 제10조 (계약갱신요구 등)\n"
        "• 상가건물 임대차보호법 제10조의3 (권리금의 정의)\n"
        "• 상가건물 임대차보호법 제10조의4 (권리금 회수기회 보호)"
    ),
    "담우": (
        "• 근로기준법 제23조 (해고 등의 제한)\n"
        "• 근로기준법 제24조 (경영상 이유에 의한 해고의 제한) - 정리해고 4요건\n"
        "• 근로기준법 제26조 (해고의 예고)\n"
        "• 근로기준법 제28조 (부당해고등의 구제신청)\n"
        "• 근로기준법 제34조 (퇴직급여 제도) - 퇴직금\n"
        "• 근로기준법 제36조 (금품 청산) - 14일 이내\n"
        "• 근로기준법 제43조의2 (임금 등 지연이자)\n"
        "• 근로기준법 제37조 (미지급 임금에 대한 지연이자)"
    ),
    "산들": (
        "• 민법 제834조 (협의상 이혼)\n"
        "• 민법 제839조의2 (재산분할청구권)\n"
        "• 민법 제840조 (재판상 이혼원인) - 부정행위 등\n"
        "• 민법 제837조 (이혼과 자의 양육책임)\n"
        "• 민법 제837조의2 (면접교섭권)\n"
        "• 민법 제909조 제4항 (이혼 시 친권자 지정)\n"
        "• 가사소송법 제2조 (가사사건의 종류와 관할)"
    ),
    "보늬": (
        ...
        "• 공인중개사법 제30조 (손해배상책임)\n"
        "• 부동산 거래신고 등에 관한 법률 제3조 (부동산거래의 신고)"
    ),
    "지누": (
        "• 개인정보 보호법 제15조 (개인정보의 수집·이용)\n"
        "• 개인정보 보호법 제17조 (개인정보의 제공)\n"
        "• 개인정보 보호법 제23조 (민감정보의 처리 제한)\n"
        "• 개인정보 보호법 제23조의2 (생체인식정보의 처리 제한)\n"
        "• 개인정보 보호법 제25조 (영상정보처리기기의 설치·운영 제한)\n"
        "• 개인정보 보호법 제34조 (개인정보 유출 통지 등)\n"
        "• 개인정보 보호법 제34조의2 (과징금 등)\n"
        "• 개인정보 보호법 제28조의7 (개인정보의 국외 이전)"
    ),
}
