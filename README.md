...
60개 도메인 특화 라우팅 + C-Level 거버넌스로 동작하는 대한민국 법률 AI 시스템
...
Lawmadi OS는 대한민국 법령·판례를 **법제처 DRF API**에서 실시간 검증하여 답변하는 법률 AI 운영체제입니다. 단순 Q&A를 넘어, **60개 도메인 특화 라우팅(키워드 + Gemini 분류)**으로 복합 법률 사안을 분석하고 5단계 구조화된 행동 계획을 제시합니다.
...
| **안전장치** | SafetyGuard + CircuitBreaker + 헌법 준수 검증 (규칙 기반 + Claude) |
