...
| 항목 | 상세 |
|:---|:---|
| **분석 엔진** | Google Gemini 3 Flash (`gemini-3-flash-preview`) |
...
| lawmadi-os-v60 | Cloud Run | 4 vCPU / 8 GiB, 최대 3 인스턴스 |
...
*Copyright (c) 2026 Jainam Choe (최재남). All rights reserved.*
*최종 업데이트: 2026-02-22 | 운영 환경: GCP asia-northeast3*
