...
(function() {
    ...
    style.textContent = ''
        + '.site-nav{position:fixed;top:0;left:0;right:0;z-index:9999;display:flex;align-items:center;justify-content:space-between;padding:8px 16px;background:rgba(16,26,21,0.85);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border-bottom:1px solid rgba(255,255,255,0.08);}'
        ...
        + '.site-nav-btn{background:none;border:1px solid rgba(255,255,255,0.15);color:#D4E4DA;cursor:pointer;padding:6px 10px;border-radius:8px;display:flex;align-items:center;gap:6px;font-size:0.8rem;font-weight:600;transition:all 0.2s;text-decoration:none;}'
        + 'body:not(.dark-mode) .site-nav-btn{border-color:rgba(0,0,0,0.15);color:#2D4038;}'
        + '.site-nav-btn:hover{border-color:rgba(74,155,110,0.5);color:#6DBB8F;}'
        + 'body:not(.dark-mode) .site-nav-btn:hover{border-color:#4A9B6E;color:#4A9B6E;}'
        + '.site-nav-btn .material-symbols-outlined{font-size:1.1rem;}'
        + '.site-nav-auth{border-color:rgba(74,155,110,0.3);}'
        ...
        + '.site-nav-dropdown{display:none;position:absolute;top:calc(100% + 6px);right:0;background:#1A2E22;border:1px solid #2D4038;border-radius:10px;box-shadow:0 8px 24px rgba(0,0,0,0.4);min-width:180px;padding:4px 0;z-index:10000;}'
        + 'body:not(.dark-mode) .site-nav-dropdown{background:#fff;border-color:#D4E4DA;box-shadow:0 8px 24px rgba(0,0,0,0.12);}'
        + '.site-nav-dd-item{display:flex;align-items:center;gap:8px;width:100%;padding:9px 14px;background:none;border:none;color:#D4E4DA;font-size:0.85rem;cursor:pointer;transition:background 0.15s;text-align:left;text-decoration:none;}'
        + 'body:not(.dark-mode) .site-nav-dd-item{color:#2D4038;}'
        + '.site-nav-dd-item:hover{background:#2D4038;}'
        + 'body:not(.dark-mode) .site-nav-dd-item:hover{background:#E4EDE8;}'
        + '.site-nav-dd-item .material-symbols-outlined{font-size:1rem;color:#7A9A88;}'
        + 'body:not(.dark-mode) .site-nav-dd-item .material-symbols-outlined{color:#5D7D6D;}'
        // Auth dropdown (logged-in user menu)
        + '.site-nav-auth-wrap{position:relative;}'
        + '.site-nav-auth-dd{display:none;position:absolute;top:calc(100% + 6px);right:0;background:#1A2E22;border:1px solid #2D4038;border-radius:10px;box-shadow:0 8px 24px rgba(0,0,0,0.4);min-width:200px;padding:4px 0;z-index:10000;}'
        + 'body:not(.dark-mode) .site-nav-auth-dd{background:#fff;border-color:#D4E4DA;box-shadow:0 8px 24px rgba(0,0,0,0.12);}'
        + '.site-nav-auth-dd-email{padding:10px 14px;font-size:0.8rem;color:#7A9A88;border-bottom:1px solid #2D4038;word-break:break-all;}'
        + 'body:not(.dark-mode) .site-nav-auth-dd-email{border-color:#D4E4DA;color:#5D7D6D;}'
        + '.site-nav-auth-dd-credits{padding:8px 14px;font-size:0.85rem;font-weight:700;border-bottom:1px solid #2D4038;}'
        + 'body:not(.dark-mode) .site-nav-auth-dd-credits{border-color:#D4E4DA;}'
        // OTP modal
        ...
        + '.sn-otp-box{background:#1A2E22;border:1px solid rgba(255,255,255,0.15);border-radius:20px;padding:36px 28px;max-width:380px;width:90%;text-align:center;position:relative;}'
        + 'body:not(.dark-mode) .sn-otp-box{background:#fff;border-color:#D4E4DA;}'
        + '.sn-otp-box h3{font-weight:800;margin-bottom:8px;}'
        + '.sn-otp-box p{color:#7A9A88;font-size:0.9rem;margin-bottom:16px;}'
        + 'body:not(.dark-mode) .sn-otp-box p{color:#5D7D6D;}'
        + '.sn-otp-input{width:100%;padding:14px 16px;background:#101A15;border:1px solid rgba(255,255,255,0.2);border-radius:12px;color:#E4EDE8;font-size:1rem;margin-bottom:12px;outline:none;}'
        + 'body:not(.dark-mode) .sn-otp-input{background:#F4F8F5;border-color:#8BAA9A;color:#101A15;}'
        + '.sn-otp-btn{width:100%;padding:14px;background:linear-gradient(135deg,#3D8B5E,#6DBB8F);border:none;border-radius:12px;color:white;font-size:1rem;font-weight:700;cursor:pointer;}'
        + '.sn-otp-btn:disabled{opacity:0.5;cursor:not-allowed;}'
        + '.sn-otp-btn.verify{background:linear-gradient(135deg,#3D8B5E,#2D7A4E);}'
        + '.sn-otp-msg{font-size:0.85rem;margin-top:8px;display:none;}'
        + '.sn-otp-close{position:absolute;top:12px;right:16px;background:none;border:none;color:#7A9A88;font-size:1.5rem;cursor:pointer;}'
        + 'body:not(.dark-mode) .sn-otp-close{color:#5D7D6D;}'
        + '.sn-otp-resend{background:none;border:none;color:#8DD4AA;font-size:0.85rem;cursor:pointer;margin-top:8px;text-decoration:underline;}'
        + 'body:not(.dark-mode) .sn-otp-resend{color:#3D8B5E;}'
