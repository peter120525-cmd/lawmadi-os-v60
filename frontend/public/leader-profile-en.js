...
(function(){var p=new URLSearchParams(window.location.search);var id=p.get('id');if(id&&/^[A-Za-z0-9]+$/.test(id)){var el=document.getElementById('langToggle');if(el)el.href='/leader?id='+encodeURIComponent(id);}})();
